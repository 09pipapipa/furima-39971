class OrderAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code,prefecture: prefecture, street_address: street_address,building_name: building_name, phone_number: phone_number,order_id: order_id)
  end
end